# OpenAI Realtime Language Tutor
...
| This Template Page | [https://suhasbhairav.com/ai-templates/openai-realtime-language-tutor](https://suhasbhairav.com/ai-templates/openai-realtime-language-tutor) |
| Creator | [https://suhasbhairav.com](https://suhasbhairav.com) |

## One-Click Deploy

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fsuhasbhairav%2Fopenai-realtime-language-tutor&env=OPENAI_API_KEY%2COPENAI_REALTIME_MODEL&envDescription=Add+the+server-side+API+keys+required+by+this+template.+These+values+are+stored+as+deployment+environment+variables+and+are+not+committed+to+the+repository.&envLink=https%3A%2F%2Fgithub.com%2Fsuhasbhairav%2Fopenai-realtime-language-tutor%23environment-variables)
...
`openai realtime voice agent template` · `voice ai agents starter` · `OpenAI voice agent template Next.js` · `Realtime WebRTC voice agent` · `AI templates` · `AI starter template` · `Next.js AI templates` · `nextjs ai templates` · `OpenAI templates` · `open ai templates` · `OpenAI Realtime Language Tutor` · `Next.js AI template`
...
- [This Template Page](https://suhasbhairav.com/ai-templates/openai-realtime-language-tutor)
